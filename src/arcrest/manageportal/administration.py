...
class _log(BaseAGOLClass):
    ...
    def query(self, logLevel="WARNING", source="ALL",
        ...
        filter_value = {
            ...
            "users": [],
            "source": "*",
            'source': "*" if source.lower() == "all" else [source],
        }
        params = {
            "f" : "json",
            "level" : logLevel
        ...
        if endTime is not None and isinstance(endTime, datetime):
            params['endTime'] = startTime.strftime("%Y-%m-%dT%H:%M:%S")
        if logCodes is not None:
            filter_value['codes'] = logCodes.split(',')
        if users is not None:
            filter_value['users'] = users.split(',')
        if messageCount is None or not isinstance(
            messageCount, (int, long, float)
        ):
...
class _Security(BaseAGOLClass):
    ...
    def createUser(self,
        ...
        Inputs:
           ...
           idpUsername - name of the user on the domain controller.
                         Ex: domain\account
        """
        url = f"{self._url}/users/createUser"
        params = {
            "f" : "json",
            "username" : username,
            "password" : password,
    ...
    def generateCertificate(self, alias,
        ...
        url = f"{self._url}/SSLCertificate/ generateCertificate"
        return self._post(url=url,
                          param_dict=params,
                          proxy_port=self._proxy_port,
                          proxy_url=self._proxy_url)
    ...
    def getAppInfo(self, appId):
        ...
        url = f"{self._url}/oauth/getAppInfo"
        return self._get(url=url, param_dict=params,
                         proxy_url=self._proxy_url,
                         proxy_port=self._proxy_port)
    #----------------------------------------------------------------------
    def getUsersEnterpriseGroups(self, username, searchFilter, maxCount=100):
        ...
        url = f"{self._url}/Groups/getEnterpriseGroupsForUser"
        return self._get(url=url,
                         param_dict=params,
                         proxy_url=self._proxy_url,
                         proxy_port=self._proxy_port)
    ...
    def getEnterpriseUser(self, username):
        """"""
        url = f"{self._url}/users/getEnterpriseUser"
        params = {
            "f" : "json",
            "username" : username
        }
    ...
    def getUsersWithinEnterpriseGroup(self,
        ...
        url = f"{self._url}/groups/getUsersWithinEnterpriseGroup"
        return self._get(url=url,
                         param_dict=params,
                         proxy_url=self._proxy_url,
                         proxy_port=self._proxy_port)
    ...
    def refreshGroupMembership(self, groups):
        ...
        url = f"{self._url}/groups/refreshMembership"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def refreshUserMembership(self, users):
        ...
        url = f"{self._url}/users/refreshMembership"
        return self._post(url=url,
                          param_dict=params,
                          proxy_port=self._proxy_port,
                          proxy_url=self._proxy_url)
    ...
    def searchEnterpriseGroups(self, searchFilter="", maxCount=100):
        ...
        url = f"{self._url}/groups/searchEnterpriseGroups"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def searchEnterpriseUsers(self, searchFilter="", maxCount=100):
        ...
        url = f"{self._url}/users/searchEnterpriseUsers"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def SSLCertificates(self):
        ...
        Lists certificates.
        """
        url = f"{self._url}/SSLCertificate"
        params = {"f" : "json"}
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
    ...
    def testIdentityStore(self):
        ...
        """
        params = {"f" : "json"}
        url = f"{self._url}/config/testIdentityStore"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def updateAppInfo(self, appInfo):
        ...
        params = {"f" : "json",
                  "appInfo" : appInfo}
        url = f"{self._url}/oauth/updateAppInfo"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def updateEnterpriseUser(self, username, idpUsername):
        ...
        url = f"{self._url}/users/updateEnterpriseUser"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def updateWebServerCertificate(self, webServerCertificateAlias,
        ...
        url = f"{self._url}/sslcertificates/update"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def updateIdenityStore(self,
        ...
        """
        url = f"{self._url}/config/updateIdentityStore"
        params = {
            "f" : "json",
...
class _System(BaseAGOLClass):
    ...
    def webAdaptor(self, webAdaptorID):
        ...
        """
        url = f"{self._url}/webadaptors/{webAdaptorID}"
        params = {
            "f" : "json"
        }
        return self._get(url=url,
    ...
    def directory(self, directoryName):
        ...
        """
        url = f"{self._url}/directories/{directoryName}"
        params = {
            "f" : "json"
        }
        return self._get(url=url,
    ...
    def editDirectory(self, directoryName, physicalPath, description):
        ...
        """
        url = f"{self._url}/directories/{directoryName}/edit"
        params = {
            "f" : "json",
    ...
    def getEntitlements(self, appId):
        ...
        url = f"{self._url}/licenses/getEntitlements"
        return self._get(url=url, param_dict=params,
                         proxy_url=self._proxy_url,
                         proxy_port=self._proxy_port)
    #----------------------------------------------------------------------
    def importEntitlements(self, entitlementFile, appId):
        ...
        url = f"{self._url}/licenses/importEntitlements"
    ...
    def releaseLicense(self, username):
        ...
        """
        url = f"{self._url}/licenses/releaseLicense"
        params = {
            "username" : username,
            "f" : "json"
        }
    ...
    def removeAllEntitlements(self, appId):
        ...
        url = f"{self._url}/licenses/removeAllEntitlements"
        return self._post(url=url,
                          param_dict=params,
                          proxy_url=self._proxy_url,
                          proxy_port=self._proxy_port)
    ...
    def updateLicenseManager(self, licenseManagerInfo):
        ...
        """
        url = f"{self._url}/licenses/updateLicenseManager"
        params = {
            "f" : "json",
    ...
    def updateDatabaseAccount(self, username,
        ...
        """
        url = f"{self._url}/database/updateAdminAccount"
        params = {
            "f" : "json",
            "username" : username,
            "password" : password
    ...
    def indexerStatus(self):
        ...
        """
        url = f"{self._url}/indexer/status"
        params = {
            "f" : "json"
        }
        return self._get(url=url,
    ...
    def reindex(self, mode, includes=""):
        ...
        """
        url = f"{self._url}/indexer/reindex"
        params = {
            "f" : "json",
            "mode" : mode,
            "includes" : includes
    ...
    def updateIndexConfiguration(self,
        ...
        """
        url = f"{self._url}/indexer/update"
        params = {
            "f" : "json",
...
class PortalAdministration(BaseAGOLClass):
    ...
    def __init__(self, admin_url,
        ...
        if admin_url.endswith("/portaladmin") == False:
            admin_url = f"{admin_url}/portaladmin"
        if securityHandler is not None:
            self._securityHandler = securityHandler
            self._referer_url = securityHandler.referer_url
    ...
    def unregisterMachine(self, machineName):
        ...
        """
        url = f"{self._url}/machines/unregister"
        params = {
            "f" : "json",
